function [Label,Dist] = gin_det_dlabels_ks(XYZmm)
%
...
load('/Applications/spm8/toolbox/3aal_for_spm8/ROI_MNI_V4_Border.mat');
load('/Applications/spm8/toolbox/3aal_for_spm8/ROI_MNI_V4_List.mat');
MNI='/Applications/spm8/toolbox/3aal_for_spm8/ROI_MNI_V4.nii';
MNID=spm_vol(MNI);
